...
namespace lib60870
{
    namespace CS101
    {
        ...
        public class CS101Slave : Slave, ISecondaryApplicationLayer, IMasterConnection
        {
            ...
            private RawMessageHandler receivedRawMessageHandler;
            private object receivedRawMessageHandlerParameter;
            private RawMessageHandler sentRawMessageHandler;
            private object sentRawMessageHandlerParameter;
            ...
            public void Run()
            {
                if (initialized == false)
                {
                    ...
                    if (receivedRawMessageHandler != null)
                        linkLayer.SetReceivedRawMessageHandler(receivedRawMessageHandler, receivedRawMessageHandlerParameter);

                    if (sentRawMessageHandler != null)
                        linkLayer.SetSentRawMessageHandler(sentRawMessageHandler, sentRawMessageHandlerParameter);
